...
import "./Savings.css"
//import {savings} from "../../utils/images"
              ...
              <div className="grid-item" key={saving.id}>
                ...
                <div className="grid-item-bottom">
                  <div className="grid-item-badges">
                    <span className="grid-item-badges">Date taken {saving.date_taken}
                  </span>
                  <span className="grid-item-badges">Ammount left $ {saving.amount_left}</span>
                  </div>
